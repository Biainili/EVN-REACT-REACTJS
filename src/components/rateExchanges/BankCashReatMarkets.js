...
function BankCashReatMarkets(props) {
  return (
    <div className="max-w-[1200px] m-auto pt-[50px]">
      <div>
        <div className="flex justify-center items-center text-center mb-8">
          <BsCashCoin size={58} color="gold" />
          <h2 className="text-center m-2 text-[46px] text-white">Banks Cash rates for today</h2>
        </div>
        ...
        {props.bankCurrency?.map((exchange, i) => {
          if (exchange?.name) {
            return (
...
export default BankCashReatMarkets;
