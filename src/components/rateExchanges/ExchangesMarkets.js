    ...
    <div className="max-w-[1200px] m-auto pt-[50px]">
      <div>
        <div className="flex justify-center items-center text-center mb-8">
          ...
          <h2 className="text-center m-2 text-[46px] text-white">Exchange rates for today</h2>
        </div>
        ...
        {props.exCurrency?.map((exchange, i) => {
          if (exchange?.name) {
            return (
              <div key={i} className="flex justify-between items-center text-black bg-[#F5F5F5] [box-shadow:0px_opx_12px_#18191b] rounded-[8px] text-sm mx-4 my-8 px-4 py-[.7rem] hover:scale-[1.04] hover:[transition:.3s_ease-in-out] hover:cursor-pointer">
